...
export default function MPosition3d (_parent, _content2d, _div) {
	...
	this.stageMoveNew = function (e) {
		...
		if(self.parent.fun_sob)self.parent.fun_sob("mouseMove")
	...
	this.stageUpNew = function (e) {
		...
		if(self.parent.fun_sob)self.parent.fun_sob("mouseUp")
	...
	this.mouseDown = function (e) {
		...
		if(self.parent.fun_sob)self.parent.fun_sob("mouseDown")
		//e.preventDefault();
		//e.stopPropagation();
		...
		if (self.isDragPan && e && (e.button === 2 ||e.button === 1)) {
			isMovePan = true;				
