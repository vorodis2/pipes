...
export function TStyle () {	
	...
	this.gCylinder =  new THREE.CylinderGeometry( 1, 1, 1, 16, 1);
	this.gStrelka =  new THREE.CylinderGeometry( 1, 0, 1, 16, 1);	
...
export class TSGeometry extends THREE.BufferGeometry {
	constructor(arr,arr2,gage) {
		super()
		this.arrPosition=[];
