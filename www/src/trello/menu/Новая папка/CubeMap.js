...
function CubeMap () {
	...
	/*
	new PLButton(main.stage, 200, 200, 'null', function(){
		self.link='null';
	});
	new PLButton(main.stage, 200, 240, 'room.hdr', function(){
		self.link='resources/customizer/cube/room.hdr';
	});
	new PLButton(main.stage, 200, 280, 'pic.png', function(){
		self.link='resources/images/pic.png';
	});

	new PLButton(main.stage, 200, 320, 'fill.png', function(){
		self.link='resources/images/fill.png';
	}); */
	...
	// https://d19e6m271w4vt5.cloudfront.net/media-prod/appproductresource/3622/0000217445/3a7d3c9c936611b80cd106ce6b49c951.octet-stream
	// https://d19e6m271w4vt5.cloudfront.net/media-prod/appproductresource/3623/0000217446/0b1510c790978863408c75a03c471c7a.octet-stream
	...
	this.loadFun = function () {
		...
		if (this._link.indexOf('.png') != -1 || this._link.indexOf('.jpg') != -1 || this._link.indexOf('.jpeg') != -1) {
			// this.loader.load(this._link, onLoadHdr1);
			
			new THREE.TextureLoader().load(this._link, onLoad1);
			return;
		}
		// if (this._link.indexOf('.hdr') != -1) {
