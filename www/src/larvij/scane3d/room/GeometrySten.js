...
//export function GeometrySten () {
//GeometrySten = function() {
export class GeometrySten  extends THREE.BufferGeometry {
    constructor() {      
        super();
        ...
        this.fillPointEdge = function(i, j, isFront) {
            ...
            if (j == 0) { 
                ...
                vectUv2.set( 1,  py1);
                vectUv3.set( 0 , py1);
                if(this._isLeft==true)this.pluspoli( !isFront );
            }
            ...
            if (j == setkaX.length-2) {// 
                ...
                vectUv2.set( 1,  py1);
                vectUv3.set( 0 , py1);
                if(this._isRight==true)this.pluspoli(isFront);
            }
        }
        ...
        this.createBuffer = function () {
            if (!arrPositionAttribut || arrPositionAttribut.length < arrPosition.length*3) {
                ...
                this.setAttribute( 'uv', new THREE.BufferAttribute( arrUvAttribut, 2 ) );

               // arrIndex = new Uint16Array(arrPosition.length);
               //  this.setAttribute( 'indexs', new THREE.BufferAttribute( arrIndex, 1 ) );

                arrNormal = new Float32Array( arrPosition.length*3 );
                this.setAttribute( 'normal', new THREE.BufferAttribute( arrNormal, 3 ) );
...
/*
    Object.defineProperty(this, "isLeft", {
        ...
        get : function() { return this._isLeft; }
    });

    Object.defineProperty(this, "isRight", {
        set : function(value){
            if (this._isRight == value) return;
            this._isRight=value
            this.update();
        },
        get : function() { return this._isRight; }
    });
